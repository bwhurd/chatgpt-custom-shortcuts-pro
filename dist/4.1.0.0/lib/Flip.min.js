...
!(function (t, e) {
        ...
        for (var e, i; t && t !== b; )
          (i = t._gsap) && i.uncache && i.get(t, 'x'),
            i &&
              ...
              !i.scaleY &&
              i.renderTransform &&
              ((i.scaleX = i.scaleY = 1e-4), i.renderTransform(1, i), e ? e.push(i) : (e = [i])),
            (t = t.parentNode);
        return e;
      })(e),
      s = v(e) ? E : M,
    ...
    return (
      t.forEach(function (t) {
        return (t.d = (function _getDOMDepth(t, e, i) {
          void 0 === i && (i = 0);
          for (
            var n = t.parentNode, r = 1e3 * Math.pow(10, i) * (e ? -1 : 1), a = e ? 900 * -r : 0;
            t;
          )
      ...
      !0 !== e &&
        ...
        (t = t.filter(function (t) {
          ...
          t.t._gsap.renderTransform(1),
            t.b.isVisible &&
              ((t.t.style.width = t.b.width + 'px'), (t.t.style.height = t.b.height + 'px'));
        }))),
      t
    );
  }
        ...
        n
          ? ((h = { t: u, b: n, a: d, sd: n.element === u ? 0 : d.isVisible ? 1 : -1 }),
            ...
            h.sd &&
              (h.sd < 0 && ((h.b = d), (h.a = n)),
              J && fa(h.b, z ? et[z] : nt),
              T && H.push((h.swap = { t: n.element, b: h.b, a: h.a, sd: -h.sd, swap: h }))),
            (u._flip = n.element._flip = tt ? tt.timeline : R))
          : d.isVisible &&
            (H.push({ t: u, b: _(d, { isVisible: 1 }), a: d, sd: 0, entering: 1 }),
              ...
              ? ((u = h.t),
                ...
                v.isVisible && g.isVisible
                  ...
                  : v.isVisible !== g.isVisible &&
                    (v.isVisible
                      ? g.isVisible ||
                        ((v.css = g.css), j.push(v), H.splice(l--, 1), S && L && ot(g, v, A, z))
  ...
  var I,
    ...
    ot = function _fit(t, e, i, n, r, a) {
      ...
      return (
        F || !m
          ...
          : ((p = (h = (function _getInverseGlobalMatrix(t) {
              ...
              return e.gmCache === Q.ticker.frame
                ? e.gMatrix
                : ((e.gmCache = Q.ticker.frame), (e.gMatrix = getGlobalMatrix(t, !0, !1, !0)));
            })(m))
              .clone()
        ...
        a &&
          ...
          (a.rotation = S),
          (a.skewX = s),
          i ? ((a.scaleX = b), (a.scaleY = w)) : ((a.width = y), (a.height = x))),
        a || d
      );
    },
    j = [],
    ...
    ut =
      ...
      (n.fit = function fit(t, e, i) {
        for (
          var n, r, a = ea(this.elementStates.slice(0), !1, !0), s = (t || this).idLookup, o = 0;
          o < a.length;
          o++
        )
          (n = a[o]),
      ...
      (n.add = function add(t) {
        for (var e, i, n, r = t.targets.length, a = this.idLookup, s = this.alt; r--; )
          ...
          (i.element === n.element || (s[i.id] && s[i.id].element === i.element))
        ...
        return (
          t.interrupted && (this.interrupted = !0), t.simple || (this.simple = !1), Da(this), this
        );
      }),
      (n.compare = function compare(t) {
        function lh(t, e, i) {
          return (
            (t.isVisible !== e.isVisible ? (t.isVisible ? f : d) : t.isVisible ? c : p).push(i) &&
            m.push(i)
          );
        }
        function mh(t, e, i) {
          ...
          (a = g[n]),
            ...
            s
              ? ((l = i.isVisible || (!s.isVisible && r === i.element) ? i : s),
                (o = !a || e.isVisible || a.isVisible || l.element !== a.element ? e : a)
                  .isVisible &&
                l.isVisible &&
                o.element !== l.element
        ...
        (s.uncache = 1),
          ...
          e &&
            (function _recordProps(t, e) {
              for (
                var i = Q.getProperty(t.element, null, 'native'), n = (t.props = {}), r = e.length;
                r--;
              )
                n[e[r]] = (i(e[r]) + '').trim();
  ...
  var pt =
    ...
    (Flip.to = function to(t, e) {
      return Aa(
        t,
        ua(e.targets || t.targets, { props: e.props || t.props, simple: e.simple, kill: !!e.kill }),
        e,
        1,
      );
    }),
  ...
  function Flip() {}
  (pt.version = '3.13.0'),
    'undefined' != typeof window && window.gsap && window.gsap.registerPlugin(pt),
    (e.Flip = pt),
    (e.default = pt);
