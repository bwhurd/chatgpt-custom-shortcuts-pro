...
!(function (t, e) {
  ...
  function hb(h, e) {
    ...
    return (
      !r &&
        v(h) &&
        ((l = r = h.radius || N),
        h.values ? ((h = Ot(h.values)), (f = !t(h[0])) && (l *= l)) : (h = gb(h.increment))),
      Xa(
        e,
        r
          ? s(h)
  ...
  var Xt,
    ...
    Nt =
      ...
      (Xt.totalDuration = function totalDuration(t) {
        return arguments.length
          ? ((this._dirty = 0),
            Sa(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur;
      }),
      ...
      (Xt.progress = function progress(t, e) {
        return arguments.length
          ? this.totalTime(
              this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + Fa(this),
              e,
            )
          : this.duration()
      ...
      (Xt.restart = function restart(t, e) {
        return (
          this.play().totalTime(t ? -this._delay : 0, w(e)), this._dur || (this._zTime = -U), this
        );
      }),
      ...
      if (
        ...
        for (t._pt = t._ptCache = 0, T = (A && w(T)) || (T && !A), n = 0; n < C.length; n++) {
          ...
          t._op && t._op[n] && t.kill(o, t._op[n]),
            z &&
              t._pt &&
              ((Ut = t), I.killTweensOf(o, d, t.globalTime(e)), (_ = !t.parent), (Ut = 0)),
            t._pt && T && (ct[h.id] = 1);
        }
          ...
          if ($(x))
            ...
            for (l in u)
              for (
                ...
                ((D = { ease: (S = C[o]).e, duration: ((S.t - (o ? C[o - 1].t : 0)) / 100) * _ })[
                  l
                ] = S.v),
                  s.to(P, D, z),
                  (z += D.duration);
      ...
      (e.kill = function kill(t, e) {
        ...
        for (
          ...
          if (~d.indexOf(f[l]))
            ...
            o))
              (h = a && a[u]) &&
                (('kill' in h.d && !0 !== h.d.kill(u)) || za(this, h, '_pt'), delete a[u]),
                'all' !== s && (s[u] = 1);
  ...
  function Kd(t, e) {
    ...
    if (t in sr && n) {
      ...
      if (
        ...
        return;
      a.svg && ((this.svgo = i.getAttribute('data-svg-origin')), this.props.push(_r, e, '')),
        (t = pr);
    }
    ...
    for (t = 0; t < r.length; t += 3)
      r[t + 1]
        ...
        : r[t + 2]
          ? (n[r[t]] = r[t + 2])
          : n.removeProperty(
              '--' === r[t].substr(0, 2) ? r[t] : r[t].replace(lr, '-$1').toLowerCase(),
            );
    if (this.tfm) {
      ...
      a.svg && (a.renderTransform(), i.setAttribute('data-svg-origin', this.svgo || '')),
        ((t = Ye()) && t.isStart) ||
          ...
          a.zOrigin &&
            n[_r] &&
            ((n[_r] += ' ' + a.zOrigin + 'px'), (a.zOrigin = 0), a.renderTransform()),
          (a.uncache = 1));
    }
  }
  function Nd(t, e) {
  ...
  function ce(t, e, r, i) {
    ...
    if (
      ...
      'auto' === i &&
        ((f = t.style[e]), (t.style[e] = i), (i = Qd(t, e) || i), f ? (t.style[e] = f) : Yd(t, e)),
      Gb((s = [r, i])),
      (i = s[1]),
      (u = (r = s[0]).match(rt) || []),
      (i.match(rt) || []).length)
  ...
  var Ee,
    ...
    zr = function _renderSVGTransforms(t, e) {
      ...
      (d = parseFloat(d)),
        ...
        (v || y || T || b) &&
          ((x = ia(x + v - (v * r + y * n) + T)), (M = ia(M + y - (v * i + y * a) + b))),
        (u || h) &&
          ((s = g.getBBox()),
          ...
          if ('autoRound' !== d && ((o = e[d]), !pt[d] || !bc(d, e, i, n, t, a)))
            if (
              ...
              if (
                ...
                if (
                  ...
                  g ||
                    ...
                    ((g = this._pt =
                      new ge(this._pt, x, pr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                  'scale' === d)
                )
                  (this._pt = new ge(
                    this._pt,
              ...
              if (m || ((u || 0 === u) && (h || 0 === h) && !dr.test(o) && d in x))
                (u = u || 0),
                  (c = (s + '').substr((h + '').length)) !==
                    (p = Za(o) || (d in X.units ? X.units[d] : c)) && (h = ae(t, d, s, p)),
                  (this._pt = new ge(
                    this._pt,
                    m ? v : x,
                    d,
